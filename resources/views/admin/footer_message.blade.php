        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Mettre à jour le message du pied de page</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
           ...
           @if (Session::has('flash_message_success'))
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- Row -->
                <form class="form p-t-20" method="POST" action="{{ url('/admin/footer-message')}}">
                    {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                        <label>Message du pied de page</label>
                                        <div class="input-group mb-3">
                                            <textarea class="form-control" name="footer_message" placeholder="Message du pied de page" aria-label="Message du pied de page" aria-describedby="basic-addon11" required></textarea>
                                        </div>
                                    </div>
                                    </div>
                                    </div>
