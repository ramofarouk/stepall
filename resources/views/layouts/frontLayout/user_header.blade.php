                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="{{url('/user/my-profile')}}"><i class="ti-user m-r-5 m-l-5"></i> Mon Profil</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{url('/user/change-password')}}"><i class="ti-settings m-r-5 m-l-5"></i> Changer de Mot de Passe</a>
                                <div class="dropdown-divider"></div>
